...
const config: DocsThemeConfig = {
  ...
  footer: {
    text: <span>
      <a href="/legal/license" target="_blank">CC-BY-4.0</a> Copyright © {new Date().getFullYear()} <a href="https://git.c-eo.repl.co" target="_blank">Nitehub Org.</a> All rights reserved.
      </span>,
  },
  head: () => {
